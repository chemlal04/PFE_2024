...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  scroll-behavior: smooth;
      ...
      .gradient {
        background: linear-gradient(90deg, #1e2029 0%, #9a6aff 100%);
      }
    </style>
  </head>
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            <li class="mr-3">
              <a class="inline-block py-2 px-4 text-gray-800 font-bold no-underline" href="#">Accueil_Admin</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-gray-800 no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#Our company">Our company</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-gray-800 no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#Admin roles">Admin roles</a>
            </li>
        <li>
          @if (Route::has('login'))
          <div  >
    ...
    <div  class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Are you admin ?</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
             Welcome to your work space !
          </h1>
          <p class="leading-normal text-2xl mb-8">
            I hope you accomplish your tasks under the best conditions. Good luck!

          </p>
        </div>
        <!--Right Col-->
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-4/5 z-50" src="image/undraw_world_re_768g.svg" />
        </div>
      </div>
    </div>
    ...
    <section id="Our company" class="bg-white border-b py-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
              Agency Keeping Pace with Development
            </h3>
            <br>
            <p class="text-gray-600 mb-8">
              Welcome to our online travel agency! We specialize in providing a wide range of travel services to make your trip planning experience seamless and enjoyable. Whether you're dreaming of a relaxing beach getaway, an adventurous mountain trek, or a cultural exploration in a bustling city, we've got you covered
              <br />
              <br />
            </p>
          </div>
          <div class="w-full sm:w-1/2 p-6">
            <svg class="w-full sm:h-64 mx-auto" viewBox="0 0 1177 598.5" xmlns="http://www.w3.org/2000/svg">
              <title>MCH_VOYAGE booking</title>
              <path
                ...
                fill="#f2f2f2"
              />
              <ellipse cx="588.5" cy="577.5" rx="588.5" ry="21" fill="#9a6aff" />
              <path
                transform="translate(-11.5 -150.75)"
                ...
                stroke-width="4"
              />
              <path transform="translate(-11.5 -150.75)" d="M81,599.39a14,14,0,0,1,7-11.5l3.14,6.22-.1-7.53a14.22,14.22,0,0,1,4.63-.56A14,14,0,1,1,81,599.39Z" fill="#9a6aff" />
              <path transform="translate(-11.5 -150.75)" d="M106,694.38a14,14,0,1,0-.68-11.3l8.77,7.13L104.46,688A14,14,0,0,0,106,694.38Z" fill="#9a6aff" />
              ...
              <path transform="translate(-11.5 -150.75)" d="m141.07 715.07s-11.08-0.34-14.42-2.72-17-5.21-17.86-1.4-16.65 19-4.15 19.06 29.06-1.94 32.4-4 4.03-10.94 4.03-10.94z" fill="#57b894" />
              <path
                transform="translate(-11.5 -150.75)"
              ...
              <path d="m172 133.75h268v434h-247.58a20.42 20.42 0 0 1 -20.42 -20.42v-413.58z" fill="#1e2029" />
              ...
              <circle cx="193" cy="127.75" r="6" fill="#9a6aff" />
              <circle cx="208" cy="127.75" r="6" fill="#9a6aff" />
              <circle cx="223" cy="127.75" r="6" fill="#9a6aff" />
              <path transform="translate(-11.5 -150.75)" d="M387.5,490A66.5,66.5,0,1,1,321,423.5,66.47,66.47,0,0,1,387.5,490Z" fill="none" stroke="#9a6aff" stroke-miterlimit="10" stroke-width="2" />
              <path transform="translate(-11.5 -150.75)" d="M325.38,467.23l8.3,13,35.53,55.59a66.5,66.5,0,0,1-103.32-8.57l43.54-84.94.91,1.43" fill="none" stroke="#9a6aff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
              <path
                transform="translate(-11.5 -150.75)"
              ...
              <path
                ...
                fill="#3f3d56"
              />
              <rect x="604" y="260.14" width="347" height="11" rx="1.24" fill="#9a6aff" opacity=".3" />
              <rect x="604" y="392.07" width="347" height="11" rx="1.24" fill="#9a6aff" opacity=".3" />
              <rect x="878" y="279.75" width="73" height="25" rx="1.24" fill="#9a6aff" />
              <rect x="878" y="411.75" width="73" height="25" rx="1.24" fill="#9a6aff" />
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <br>
              <p class="text-gray-600 mb-8">
                Our dedicated team of travel experts is available around the clock to assist you with any questions or concerns you may have before, during, or after your trip. Whether you need assistance with booking changes, itinerary planning, or emergency assistance, we're here to help every step of the way.
                <br />
                <br />
              </p>
            </div>
    ...
    <section id="Admin roles" class="bg-white border-b py-8">
          ...
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                As a flight administrator, your role involves overseeing all aspects of flight operations within our travel agency. This includes managing flight bookings, coordinating schedules, and ensuring compliance with airline regulations. You'll work closely with airlines to secure the best deals for our customers and handle any issues or changes that may arise during the booking process. Additionally, you'll monitor flight availability, track reservations, and provide support to customers regarding their flight arrangements. Your attention to detail and strong organizational skills will ensure smooth and efficient flight operations for our agency.
              </p>
            </a>
          </div>
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                As a hotel administrator, you'll be responsible for managing our extensive portfolio of accommodations and lodging options. Your role involves overseeing hotel reservations, negotiating contracts with hotel partners, and maintaining up-to-date information on available properties. You'll work closely with our customers to help them find the perfect hotel for their travel needs, taking into account factors such as location, amenities, and budget. Additionally, you'll handle inquiries and resolve any issues related to hotel bookings, ensuring a seamless experience for our clients from check-in to check-out.
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
            <a href="#" class="flex flex-wrap no-underline hover:no-underline">
              ...
              <p class="text-gray-800 text-base px-6 mb-5">
                As a transportation administrator, you'll play a key role in managing our transportation services, including car rentals, airport transfers, and other ground transportation options. Your responsibilities will include coordinating vehicle reservations, scheduling pick-ups and drop-offs, and ensuring the safety and comfort of our customers during their travels. You'll work closely with transportation providers to secure reliable and efficient services for our clients, negotiating rates and managing contracts as needed. Additionally, you'll handle customer inquiries and address any concerns related to transportation arrangements, providing assistance and support to ensure a smooth and enjoyable travel experience.
              </p>
            </a>
          </div>
          <div class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-4 text-3xl leading-tight">
        Ladies and Gentlemen, welcome to your own space.
      </h3>
      @if (Route::has('login'))
          <div>
              @auth
              ...
              @else
                  ...
                  class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full mt-4 lg:mt-0 py-4 px-8 shadow opacity-75 focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out">Log in</a>
